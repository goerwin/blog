...
```sh
- ssh goerwin@goerwin.co 'rm -rf /var/www/blog.goerwin.co/html && mkdir /var/www/blog.goerwin.co/html' && scp -r ./__generatedBlog__/* goerwin@goerwin.co:/var/www/blog.goerwin.co/html
```
